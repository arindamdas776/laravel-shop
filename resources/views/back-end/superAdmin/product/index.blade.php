                            ...
                            <h2>
                                All Products Details
                                	...
                                	<div class="col-md-3 pt-4">
                                		<a href="{{route('adminproducts.create')}}" class="btn btn-primary">CREATE</a>
                                	</div>
                            ...
                            <div class="table-responsive">
                                ...
                                @endforeach
                                        ...
                                        <td>{{str_limit($product->description,10)}}</td>
                                            ...
                                            <td><a href="{{route('adminproducts.edit',$product->id)}}" class="btn btn-success">Edit</a></td>
                                            <td><a href="#" class="btn btn-danger" onclick="
                                                document.getElementById('delete-category-{{$product->id}}').submit();
                                            ">Destroy</a>
                                    <form method="post" action="{{route('adminproducts.destroy',$product->id)}}" id="delete-category-{{$product->id}}">
                                        @csrf
                                        @method('delete')
                                    </form>
                                        </td>
