...
@section('content')
 <div class="card">
                        ...
                        <div class="body">
                            <form  action="{{route('sellerproducts.update',$products->id)}}" method="POST" enctype="multipart/form-data">
                            	@csrf
                              @method('put')
                        ...
                        <div class="alert alert-danger">
                            ...
                            @endif
                 @php 
                    $ids = (null !==($products) && $products->categories->count() >0 ? array_pluck($products->categories->toArray(),'id'):null);
