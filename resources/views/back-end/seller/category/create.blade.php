...
@section('content')
	 <div class="card">
                        ...
                        <div class="body">
                            <form action="{{route('sellercategories.store')}}" method="POST" enctype="multipart/form-data">
                            	@csrf
                                <label for="email_address">Category Title</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="category_name" class="form-control" placeholder="Enter Category Title">
                                    </div>
                                </div>
